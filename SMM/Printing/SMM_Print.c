...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "SMM_Print",
        "sources": [
            "/Users/rob/PycharmProjects/SMM-Analysis/SMM/Printing/SMM_Print.pyx"
        ]
    },
    "module_name": "SMM_Print"
}
END: Cython Metadata */
...
#define __PYX_HAVE__SMM_Print
#define __PYX_HAVE_API__SMM_Print
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'SMM_Print' */
...
static int __pyx_f_9SMM_Print_exceeds_minimum(double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_9SMM_Print_search_fix(int, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
...
#define __Pyx_MODULE_NAME "SMM_Print"
extern int __pyx_module_is_main_SMM_Print;
int __pyx_module_is_main_SMM_Print = 0;

/* Implementation of 'SMM_Print' */
...
static const char __pyx_k_print_order[] = "print_order";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_bad_distance[] = "bad_distance";
...
static const char __pyx_k_Failed_to_improve[] = "Failed to improve";
...
static PyObject *__pyx_kp_u_Failed_to_improve;
...
static PyObject *__pyx_n_s_bad_distance;
...
static PyObject *__pyx_n_s_print_order;
...
static PyObject *__pyx_pf_9SMM_Print_exceeds_minimum(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_threshold, __Pyx_memviewslice __pyx_v_print_order, __Pyx_memviewslice __pyx_v_space, __Pyx_memviewslice __pyx_v_times); /* proto */
static PyObject *__pyx_pf_9SMM_Print_2search_fix(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_bad_index, double __pyx_v_bad_distance, __Pyx_memviewslice __pyx_v_print_order, __Pyx_memviewslice __pyx_v_space, __Pyx_memviewslice __pyx_v_times); /* proto */
 ...
 * cpdef bint exceeds_minimum(double threshold,             # <<<<<<<<<<<<<<
 *                              int [:] print_order,
 *                              double [:,:] space, double [:] times):
 */

static PyObject *__pyx_pw_9SMM_Print_1exceeds_minimum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_9SMM_Print_exceeds_minimum(double __pyx_v_threshold, __Pyx_memviewslice __pyx_v_print_order, __Pyx_memviewslice __pyx_v_space, __Pyx_memviewslice __pyx_v_times, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_t_11;
  __Pyx_RefNannySetupContext("exceeds_minimum", 0);

  /* "SMM_Print.pyx":11
 *                              int [:] print_order,
 *                              double [:,:] space, double [:] times):
 *     cdef Py_ssize_t size = print_order.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double time, distance
 *     cdef double [:] d1
 */
  __pyx_v_size = (__pyx_v_print_order.shape[0]);

  /* "SMM_Print.pyx":16
 *     cdef Py_ssize_t i, j, p1
 * 
 *     for i in range(size):             # <<<<<<<<<<<<<<
 *         time = times[i]
 *         p1 = print_order[i]
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_time = (*((double *) ( /* dim=0 */ (__pyx_v_times.data + __pyx_t_4 * __pyx_v_times.strides[0]) )));
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_p1 = (*((int *) ( /* dim=0 */ (__pyx_v_print_order.data + __pyx_t_4 * __pyx_v_print_order.strides[0]) )));
 ...
 */
    __pyx_t_5.data = __pyx_v_space.data;
    __pyx_t_5.memview = __pyx_v_space.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_p1;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_space.strides[0];
        __pyx_t_5.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_5.shape[0] = __pyx_v_space.shape[1];
__pyx_t_5.strides[0] = __pyx_v_space.strides[1];
 ...
 * 
 *         for j in range(i+1, size):             # <<<<<<<<<<<<<<
 *             distance = d1[print_order[j]] * abs(times[j] - time)
 ...
 */
      __pyx_t_4 = __pyx_v_j;
      __pyx_t_9 = (*((int *) ( /* dim=0 */ (__pyx_v_print_order.data + __pyx_t_4 * __pyx_v_print_order.strides[0]) )));
      __pyx_t_10 = __pyx_v_j;
      __pyx_v_distance = ((*((double *) ( /* dim=0 */ (__pyx_v_d1.data + __pyx_t_9 * __pyx_v_d1.strides[0]) ))) * fabs(((*((double *) ( /* dim=0 */ (__pyx_v_times.data + __pyx_t_10 * __pyx_v_times.strides[0]) ))) - __pyx_v_time)));
 ...
 *     return True
 */
      __pyx_t_11 = ((__pyx_v_distance < __pyx_v_threshold) != 0);
      if (__pyx_t_11) {
...
/* Python wrapper */
static PyObject *__pyx_pw_9SMM_Print_1exceeds_minimum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9SMM_Print_1exceeds_minimum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_threshold;
  __Pyx_memviewslice __pyx_v_print_order = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("exceeds_minimum (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_threshold,&__pyx_n_s_print_order,&__pyx_n_s_space,&__pyx_n_s_times,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_print_order)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("exceeds_minimum", 1, 4, 4, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_space)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("exceeds_minimum", 1, 4, 4, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_times)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("exceeds_minimum", 1, 4, 4, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "exceeds_minimum") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_threshold = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_threshold == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_print_order = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_print_order.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_space = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_space.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_times = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_times.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("exceeds_minimum", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("SMM_Print.exceeds_minimum", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9SMM_Print_exceeds_minimum(__pyx_self, __pyx_v_threshold, __pyx_v_print_order, __pyx_v_space, __pyx_v_times);
...
static PyObject *__pyx_pf_9SMM_Print_exceeds_minimum(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_threshold, __Pyx_memviewslice __pyx_v_print_order, __Pyx_memviewslice __pyx_v_space, __Pyx_memviewslice __pyx_v_times) {
  ...
  if (unlikely(!__pyx_v_print_order.memview)) { __Pyx_RaiseUnboundLocalError("print_order"); __PYX_ERR(0, 8, __pyx_L1_error) }
  if (unlikely(!__pyx_v_space.memview)) { __Pyx_RaiseUnboundLocalError("space"); __PYX_ERR(0, 8, __pyx_L1_error) }
  if (unlikely(!__pyx_v_times.memview)) { __Pyx_RaiseUnboundLocalError("times"); __PYX_ERR(0, 8, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_f_9SMM_Print_exceeds_minimum(__pyx_v_threshold, __pyx_v_print_order, __pyx_v_space, __pyx_v_times, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_print_order, 1);
 ...
 * @cython.wraparound(False)
 * @cython.boundscheck(False)
 * cpdef search_fix(int bad_index, double bad_distance,             # <<<<<<<<<<<<<<
 *                int [:] print_order, double[:,:] space, double [:] times):
 *     cdef int size = print_order.shape[0]
 */

static PyObject *__pyx_pw_9SMM_Print_3search_fix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_9SMM_Print_search_fix(int __pyx_v_bad_index, double __pyx_v_bad_distance, __Pyx_memviewslice __pyx_v_print_order, __Pyx_memviewslice __pyx_v_space, __Pyx_memviewslice __pyx_v_times, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_size;
  int __pyx_v_spot_index_1;
  int __pyx_v_spot_index_2;
  int __pyx_v_i3;
  double __pyx_v_time1;
  double __pyx_v_time2;
  double __pyx_v_t3;
  __Pyx_memviewslice __pyx_v_dist1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_dist2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_output_order = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_test_index;
  int __pyx_v_i;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("search_fix", 0);
 ...
 *     cdef int size = print_order.shape[0]             # <<<<<<<<<<<<<<
 * 
 *     cdef int spot_index_1 = print_order[bad_index]
 */
  __pyx_v_size = (__pyx_v_print_order.shape[0]);
 ...
 * 
 *     cdef int spot_index_1 = print_order[bad_index]             # <<<<<<<<<<<<<<
 *     cdef int spot_index_2, i3
 *     cdef double time1 = times[bad_index]
 */
  __pyx_t_1 = __pyx_v_bad_index;
  __pyx_v_spot_index_1 = (*((int *) ( /* dim=0 */ (__pyx_v_print_order.data + __pyx_t_1 * __pyx_v_print_order.strides[0]) )));

  /* "SMM_Print.pyx":36
 *     cdef int spot_index_1 = print_order[bad_index]
 *     cdef int spot_index_2, i3
 *     cdef double time1 = times[bad_index]             # <<<<<<<<<<<<<<
 *     cdef double time2, t3
 *     cdef double [:] dist1 = space[spot_index_1]
 */
  __pyx_t_1 = __pyx_v_bad_index;
  __pyx_v_time1 = (*((double *) ( /* dim=0 */ (__pyx_v_times.data + __pyx_t_1 * __pyx_v_times.strides[0]) )));
 ...
 *     cdef double [:] dist1 = space[spot_index_1]             # <<<<<<<<<<<<<<
 *     cdef double [:] dist2
 *     cdef int [:] output_order = print_order.copy()
 */
  __pyx_t_2.data = __pyx_v_space.data;
  __pyx_t_2.memview = __pyx_v_space.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
  {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_spot_index_1;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_space.strides[0];
        __pyx_t_2.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_2.shape[0] = __pyx_v_space.shape[1];
__pyx_t_2.strides[0] = __pyx_v_space.strides[1];
    __pyx_t_2.suboffsets[0] = -1;

__pyx_v_dist1 = __pyx_t_2;
 ...
 *     cdef int [:] output_order = print_order.copy()             # <<<<<<<<<<<<<<
 * 
 *     cdef int test_index, i
 */
  __pyx_t_3 = __pyx_memoryview_copy_slice_dc_int_c(__pyx_v_print_order); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 40, __pyx_L1_error)
  __pyx_v_output_order = __pyx_t_3;
 ...
 *         if test_index == bad_index:
 *             continue
 */
  __pyx_t_4 = __pyx_v_size;
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_test_index = __pyx_t_6;
 ...
 *         if test_index == bad_index:             # <<<<<<<<<<<<<<
 *             continue
 *         spot_index_2 = print_order[test_index]
 */
    __pyx_t_7 = ((__pyx_v_test_index == __pyx_v_bad_index) != 0);
    if (__pyx_t_7) {
 ...
 *         spot_index_2 = print_order[test_index]             # <<<<<<<<<<<<<<
 *         time2 = times[test_index]
 *         dist2 = space[spot_index_2]
 */
    __pyx_t_1 = __pyx_v_test_index;
    __pyx_v_spot_index_2 = (*((int *) ( /* dim=0 */ (__pyx_v_print_order.data + __pyx_t_1 * __pyx_v_print_order.strides[0]) )));
 ...
 */
    __pyx_t_1 = __pyx_v_test_index;
    __pyx_v_time2 = (*((double *) ( /* dim=0 */ (__pyx_v_times.data + __pyx_t_1 * __pyx_v_times.strides[0]) )));
 ...
 */
    ...
    __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_spot_index_2;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_space.strides[0];
        __pyx_t_2.data += __pyx_tmp_idx * __pyx_tmp_stride;
}
...
__PYX_XDEC_MEMVIEW(&__pyx_v_dist2, 1);
 ...
 */
      __pyx_t_1 = __pyx_v_i;
      __pyx_v_i3 = (*((int *) ( /* dim=0 */ (__pyx_v_print_order.data + __pyx_t_1 * __pyx_v_print_order.strides[0]) )));
 ...
 *             t3 = times[i]             # <<<<<<<<<<<<<<
 *             if bad_index != i:
 *                 if dist1[i3] * abs(time2 - t3) < bad_distance:
 */
      __pyx_t_1 = __pyx_v_i;
      __pyx_v_t3 = (*((double *) ( /* dim=0 */ (__pyx_v_times.data + __pyx_t_1 * __pyx_v_times.strides[0]) )));
 ...
 *                     break
 */
      __pyx_t_7 = ((__pyx_v_bad_index != __pyx_v_i) != 0);
      if (__pyx_t_7) {
 ...
 *             if test_index != i:
 */
        __pyx_t_1 = __pyx_v_i3;
        __pyx_t_7 = ((((*((double *) ( /* dim=0 */ (__pyx_v_dist1.data + __pyx_t_1 * __pyx_v_dist1.strides[0]) ))) * fabs((__pyx_v_time2 - __pyx_v_t3))) < __pyx_v_bad_distance) != 0);
        if (__pyx_t_7) {
 ...
 *                     break             # <<<<<<<<<<<<<<
 *             if test_index != i:
 *                 if dist2[i3] * abs(time1 - t3) < bad_distance:
 */
          goto __pyx_L7_break;
 ...
 *                     break
 */
      __pyx_t_7 = ((__pyx_v_test_index != __pyx_v_i) != 0);
      if (__pyx_t_7) {
 ...
 */
        __pyx_t_1 = __pyx_v_i3;
        __pyx_t_7 = ((((*((double *) ( /* dim=0 */ (__pyx_v_dist2.data + __pyx_t_1 * __pyx_v_dist2.strides[0]) ))) * fabs((__pyx_v_time1 - __pyx_v_t3))) < __pyx_v_bad_distance) != 0);
        if (__pyx_t_7) {
 ...
 *                     break             # <<<<<<<<<<<<<<
 *             if i == (size - 1):
 *                 output_order[bad_index] = spot_index_2
 */
          goto __pyx_L7_break;
 ...
 *             if i == (size - 1):             # <<<<<<<<<<<<<<
 *                 output_order[bad_index] = spot_index_2
 *                 output_order[test_index] = spot_index_1
 */
 ...
 */
        __pyx_t_1 = __pyx_v_bad_index;
        *((int *) ( /* dim=0 */ (__pyx_v_output_order.data + __pyx_t_1 * __pyx_v_output_order.strides[0]) )) = __pyx_v_spot_index_2;
 ...
 *                 output_order[test_index] = spot_index_1             # <<<<<<<<<<<<<<
 *                 return output_order
 *     raise RuntimeError("Failed to improve")
 */
        __pyx_t_11 = __pyx_v_test_index;
        *((int *) ( /* dim=0 */ (__pyx_v_output_order.data + __pyx_t_11 * __pyx_v_output_order.strides[0]) )) = __pyx_v_spot_index_1;
 ...
 */
        __Pyx_XDECREF(__pyx_r);
        __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_output_order, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 62, __pyx_L1_error)
 ...
 *     raise RuntimeError("Failed to improve")             # <<<<<<<<<<<<<<
 */
  __pyx_t_12 = __Pyx_PyObject_Call(__pyx_builtin_RuntimeError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
 ...
 */
  ...
  __Pyx_AddTraceback("SMM_Print.search_fix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_dist1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_dist2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_output_order, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_9SMM_Print_3search_fix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9SMM_Print_3search_fix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_bad_index;
  double __pyx_v_bad_distance;
  __Pyx_memviewslice __pyx_v_print_order = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_space = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("search_fix (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_bad_index,&__pyx_n_s_bad_distance,&__pyx_n_s_print_order,&__pyx_n_s_space,&__pyx_n_s_times,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bad_index)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bad_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("search_fix", 1, 5, 5, 1); __PYX_ERR(0, 30, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_print_order)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("search_fix", 1, 5, 5, 2); __PYX_ERR(0, 30, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_space)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("search_fix", 1, 5, 5, 3); __PYX_ERR(0, 30, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_times)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("search_fix", 1, 5, 5, 4); __PYX_ERR(0, 30, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "search_fix") < 0)) __PYX_ERR(0, 30, __pyx_L3_error)
      }
    ...
    __pyx_v_bad_index = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_bad_index == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L3_error)
    __pyx_v_bad_distance = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_bad_distance == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L3_error)
    __pyx_v_print_order = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_print_order.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_space = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_space.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_times = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_times.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("search_fix", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 30, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("SMM_Print.search_fix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9SMM_Print_2search_fix(__pyx_self, __pyx_v_bad_index, __pyx_v_bad_distance, __pyx_v_print_order, __pyx_v_space, __pyx_v_times);
...
static PyObject *__pyx_pf_9SMM_Print_2search_fix(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_bad_index, double __pyx_v_bad_distance, __Pyx_memviewslice __pyx_v_print_order, __Pyx_memviewslice __pyx_v_space, __Pyx_memviewslice __pyx_v_times) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("search_fix", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_print_order.memview)) { __Pyx_RaiseUnboundLocalError("print_order"); __PYX_ERR(0, 30, __pyx_L1_error) }
  if (unlikely(!__pyx_v_space.memview)) { __Pyx_RaiseUnboundLocalError("space"); __PYX_ERR(0, 30, __pyx_L1_error) }
  if (unlikely(!__pyx_v_times.memview)) { __Pyx_RaiseUnboundLocalError("times"); __PYX_ERR(0, 30, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9SMM_Print_search_fix(__pyx_v_bad_index, __pyx_v_bad_distance, __pyx_v_print_order, __pyx_v_space, __pyx_v_times, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "SMM_Print._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"exceeds_minimum", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9SMM_Print_1exceeds_minimum, METH_VARARGS|METH_KEYWORDS, 0},
  {"search_fix", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9SMM_Print_3search_fix, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_SMM_Print(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_SMM_Print},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Failed_to_improve, __pyx_k_Failed_to_improve, sizeof(__pyx_k_Failed_to_improve), 0, 1, 0, 0},
  ...
  {&__pyx_n_s_bad_distance, __pyx_k_bad_distance, sizeof(__pyx_k_bad_distance), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_print_order, __pyx_k_print_order, sizeof(__pyx_k_print_order), 0, 0, 1, 1},
 ...
 *     raise RuntimeError("Failed to improve")             # <<<<<<<<<<<<<<
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Failed_to_improve); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 63, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initSMM_Print(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initSMM_Print(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_SMM_Print(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_SMM_Print(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_SMM_Print(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'SMM_Print' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_SMM_Print(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("SMM_Print", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_SMM_Print) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "SMM_Print")) {
      if (unlikely(PyDict_SetItemString(modules, "SMM_Print", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init SMM_Print", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init SMM_Print");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
